...
/***/ function(module, exports, __webpack_require__) {
	...
	var bottomController = new _scrollmagic2.default.Controller({
	...
	new _scrollmagic2.default.Scene({ triggerElement: '.footer' }).setTween(".footer", { "margin-top": "-80px", ease: Linear.easeOut }).addTo(bottomController);
